    ...
    questions: [
      {
        ...
        a: "نقبل الدفع عبر البطاقات الائتمانية (فيزا، ماستركارد)، مدى، أبل باي، التحويل البنكي، والدفع عند الاستلام للطلبات التي لا تتجاوز 5000 شيكل."
      },
      {
  ...
  },
  {
    ...
    questions: [
      ...
      },
      {
        ...
        a: "نعم، نقدم شحناً مجانياً للطلبات التي تتجاوز قيمتها [FREE_SHIPPING_THRESHOLD] شيكل."
      },
      {
        q: "كيف أتتبع شحنتي؟",
