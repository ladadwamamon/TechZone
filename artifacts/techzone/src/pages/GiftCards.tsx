...
export default function GiftCardsPage() {
  const { data, isLoading } = useListProducts({ category: "gift-cards", limit: 100 });
      ...
      <div className="border-b border-primary/20 py-10 relative overflow-hidden glass-panel">
        <div className="container mx-auto px-4 relative z-10">
          <div className="flex items-center gap-4 mb-3">
            ...
            <div>
              <h1 className="text-3xl font-black neon-text">بطاقات الهدايا الرقمية</h1>
              <p className="text-muted-foreground text-sm mt-1">
                بطاقات iTunes و Steam و PlayStation و Xbox و غيرها — تسليم فوري للكود بعد الشراء
              </p>
            </div>
          </div>
      ...
      <div className="container mx-auto px-4 py-10">
        {isLoading ? (
          ...
          <div className="text-center py-20 text-muted-foreground flex flex-col items-center gap-4">
            ...
            <p>لا توجد بطاقات هدايا متاحة حالياً</p>
          </div>
        )}
      </div>
    </Layout>
